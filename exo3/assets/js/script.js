...
ctx.fillStyle = 'white';
//Oeil gauche
ctx.arc(180,90,9,0,Math.PI*2);
//Oeil droit
ctx.arc(220,90,9,0,Math.PI*2);
//Entre jambes
ctx.moveTo(180,360);
...
//Soucil gauche
ctx.moveTo(170,75);
ctx.quadraticCurveTo(180,75,190,75);
//Soucil droit
ctx.moveTo(210,75);
ctx.quadraticCurveTo(220,75,230,75);
ctx.stroke();
...
//Bouche haut
ctx.moveTo(175,120);
ctx.quadraticCurveTo(200,100,225,120);
//Bouche bas
ctx.moveTo(175,120);
ctx.quadraticCurveTo(200,100,225,120);
ctx.stroke();
